...
@app.get("/")
async def home():
    return {"message": "Use POST /auto-label to label your images using YOLOv8x."}
...
if __name__ == "__main__":
    uvicorn.run("yolov8x_app:app", host="127.0.0.1", port=8000, reload=True)
