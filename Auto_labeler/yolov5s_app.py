...
@app.get("/")
async def home():
    return {"message": "Use POST /auto-label to label your images using YOLOv5s."}
...
if __name__ == "__main__":
    uvicorn.run("yolov5s_app:app", host="127.0.0.1", port=8001, reload=True)
