...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    window.location.href = "https://your-ngrok-subdomain.ngrok.io/auth/google";
  };
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-hidden z-50">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col lg:flex-row items-center min-h-screen gap-8">
        {/* ✅ Left - Welcome Text */}
        <div className="w-full lg:min-h-screen lg:w-1/2 text-white p-6 sm:p-8 lg:p-12 order-1 flex items-center justify-center text-center lg:text-left">
          <div>
        ...
        <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-12 bg-white bg-opacity-90 rounded-lg order-2">
          ...
          <p className="text-sm mb-6 text-gray-600">
            ...
            <Link to="/signup" className="text-blue-600 font-semibold hover:text-blue-600">
              Create your account
            </Link>
          </p>
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center text-sm gap-2">
              ...
              <Link to="/forgetPassword" className="text-blue-500 hover:text-blue-700">
                Forgot password?
              </Link>
            </div>
